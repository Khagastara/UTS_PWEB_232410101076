    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <div class="text-center mb-8">
                <h1 class="text-3xl font-bold text-blue-600">MEDCHECK</h1>
            ...
            <form action="{{ route('loginProcess') }}" method="POST" class="space-y-6">
                @csrf
                <div>
            ...
            <div class="mt-6 text-center text-sm">
                <p class="text-gray-600">Akun Demo: Khagastara / AdminTest123</p>
            </div>
        </div>
    </div>
</div>
